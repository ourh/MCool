...
def DXPreconditioner(Cycle,epsilon=0.96):
    ...
    def OBJECTIVE(x):
        ...
        Qcond=epsilon*Cycle.Condenser.Fins.Air.Vdot_ha/rho_air*(Cycle.Condenser.Fins.Air.Tdb-Tcond)*1000
        ...
        Qevap_dry=epsilon*Cycle.Evaporator.Fins.Air.Vdot_ha/rho_air*(Cycle.Evaporator.Fins.Air.Tdb-Tevap)*1000
        ...
        Tdewpoint=HAProps('D','T',Cycle.Evaporator.Fins.Air.Tdb, 'P',101.325, 'R',Evap.Fins.Air.RH)
        
        #Now calculate the fully-wet analysis
        #Evaporator is bounded by saturated air at the refrigerant temperature.
        h_ai=HAProps('H','T',Cycle.Evaporator.Fins.Air.Tdb, 'P',101.325, 'R', Cycle.Evaporator.Fins.Air.RH)*1000 #[J/kg_da]
        h_s_w_o=HAProps('H','T',Tevap, 'P',101.325, 'R', 1.0)*1000 #[J/kg_da]
        ...
        Qcond_enthalpy=Cycle.Compressor.mdot_r*(Cycle.Compressor.hout_r-Props('H','T',Tcond-Cycle.DT_sc_target,'P',pcond,Cycle.Ref)*1000)
...
def SecondaryLoopPreconditioner(Cycle,epsilon=0.9):
    ...
    def OBJECTIVE(x):
        ...
        if Cycle.Mode=='AC':
            ...
            Qcoolingcoil_dry=epsilon*Cycle.CoolingCoil.Fins.Air.Vdot_ha/rho_air*(Cycle.CoolingCoil.Fins.Air.Tdb-Tin_CC)*1000
            ...
            cp_g=Props('C','T',Tin_CC,'P',Cycle.Pump.pin_g,Cycle.Pump.Ref_g)*1000
            ...
            Tdewpoint=HAProps('D','T',CC.Fins.Air.Tdb, 'P',101.325, 'R',CC.Fins.Air.RH)#HumAir_Single(CC.Fins.Air.Tdb, 101.325, 'RH',CC.Fins.Air.RH,'DewPoint')
            #Now calculate the fully-wet analysis
            #Evaporator is bounded by saturated air at the refrigerant temperature.
            h_ai=HAProps('H','T',CC.Fins.Air.Tdb, 'P',101.325, 'R', CC.Fins.Air.RH)#HumAir_Single(CC.Fins.Air.Tdb, 101.325, 'RH', CC.Fins.Air.RH,'Enthalpy')
            h_s_w_o=HAProps('H','T',Tin_CC, 'P',101.325, 'R',1)#HumAir_Single(Tin_CC, 101.325, 'RH', 1.0,'Enthalpy')
            Qcoolingcoil_wet=epsilon*CC.Fins.Air.Vdot_ha/rho_air*(h_ai-h_s_w_o)*1000
            ...
            Qevap=epsilon*Cycle.Evaporator.Fins.Air.Vdot_ha/rho_air*(Cycle.Evaporator.Fins.Air.Tdb-Tevap)*1000
            ...
            Qcoolingcoil=epsilon*Cycle.CoolingCoil.Fins.Air.Vdot_ha/rho_air*(Tin_CC-Cycle.CoolingCoil.Fins.Air.Tdb)*1000
            
            cp_g=Props('C','T',Tin_CC,'P',Cycle.Pump.pin_g,Cycle.Pump.Ref_g)*1000
            Tin_IHX=Tin_CC-Qcoolingcoil/(Cycle.Pump.mdot_g*cp_g)
            QIHX=epsilon*Cycle.Pump.mdot_g*cp_g*(Tin_IHX-Tcond)
            
            QIHX_enthalpy=Cycle.Compressor.mdot_r*(Cycle.Compressor.hout_r-Props('H','T',Tcond-Cycle.DT_sc_target,'P',pcond,Cycle.Ref)*1000)
